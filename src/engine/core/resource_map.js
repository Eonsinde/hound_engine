...
function set(key, value) { 
    mMap.get(key).set(value); // same as MapEntryInstance.set(value);
}
...
// fetch from server
// decodeResource on the loaded package
// parseResource on the decodedResource
// store result into the map
